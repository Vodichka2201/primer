...
alert("Всем привет. Сайт пока что работает только на компьютере. Кнопка сложность не работает. Вводите количество примеров, нажимаете (Готово), потом нажимаете (Начать). В ответ пишите ответ, и нажимаете 1 раз на кнопку (Ответ), а затем на кнопку (Далее). Это очень важно. (Если вы на телефоне, нажмите сразу (Далее), без (Начать), а дальше, как описано ранее)");
